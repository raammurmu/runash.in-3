...
export default function RunashChatPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-orange-50 dark:from-gray-950 dark:to-gray-900">
            ...
            <HoverCard>
              ...
              <HoverCardContent align="end">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold">RunAsh Operator</div>
                    <div className="text-xs text-gray-500">Profile, settings, and agent preferences</div>
                  </div>
                </div>
              </HoverCardContent>
            </HoverCard>
      ...
      <main className="container mx-auto grid grid-cols-1 gap-6 px-4 py-10 lg:grid-cols-3">
        <section className="space-y-6 lg:col-span-2">
          <Alert>
            <AlertTriangle className="h-4 w-4" />
            <AlertTitle>Production note</AlertTitle>
            <AlertDescription>Agentic commerce and payment tools are active. Always confirm final payment actions before checkout submission.</AlertDescription>
          </Alert>
      ...
      <Button
        onClick={() => startChatWithPrompt("Start an agentic commerce session and optimize cart-to-payment conversion.")}
