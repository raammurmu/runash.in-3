            ...
            <Sheet>
              ...
              >
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Suggestions, mini preview, and commerce playbook.
                  </SheetDescription>
                </SheetHeader>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <Card className="p-4">
                    <h4 className="mb-2 font-semibold">{t.settings}</h4>
                    <div className="space-y-2 text-sm">
                      ...
                      >
                        <Globe className="mr-2 h-4 w-4" /> {t.profile}
                      </Button>
                      <Button
                        size="sm"
                        variant="outline"
                        className="w-full justify-start"
                        onClick={() => router.push("/manifest.json")}
                      >
                        {t.pwa}
                      </Button>
                    </div>
          ...
          <Card className="p-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {(
                    ["orange", "teal", "violet", "green", "red"] as Accent[]
                  ).map((tone) => (
                    <button
                      key={tone}
                      type="button"
