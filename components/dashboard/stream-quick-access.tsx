          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={streamCategory} onValueChange={(value) => setStreamCategory(value as StreamCategory)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            <div className="flex items-center space-x-2">
              <select
                ...
                onChange={(e) => setScheduleCategory(e.target.value as StreamCategory)}
